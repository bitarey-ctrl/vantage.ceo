    ...
    <div>
      ...
      {sent ? (
        <div className="flex flex-col items-center gap-4 py-4">
          ...
          <p className="text-[#a0a0a0] text-xs font-mono text-center max-w-sm">
          ...
          <Link
            href="/login"
            className="mt-4 text-[#1b7ff0] hover:text-[#4a9ff5] text-xs font-mono transition-colors duration-150"
          >
            ← Back to sign in
          </Link>
        </div>
